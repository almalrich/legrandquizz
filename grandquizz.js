var arrObj = [{
    "question": "combien compte-t-on de 1ers Grands Cru Classés en France legis 1855?",
    "reponses": "3",
    "couleur": "vert"
},/*tableau d'objets*/
    ...
    {
        "question": "Quel est la quantité d'une bouteille standard de vin en France?",
        "reponses": "4",
        "couleur": "rouge"
    },
    {
        "question": "De quelle couleur est la colerette d'une bouteille d'un A.O.C en France?",
        "reponses": "2",
        "couleur": "bleu"
    },
...
let proposition = [{"repons1": "3", "repons2": "4", "repons3": "5", "repons4": "7", "correct": "5"},
    {
        "repons1": "bourgogne",
        "repons2": "bordeaux",
        "repons3": "côte du rhone",
        "repons4": "beaujolais",
        "correct": "beaujolais"
    },
    {"repons1": "1", "repons2": "2", "repons3": "3", "repons4": "4", "correct": "2"},
    {
        "repons1": "un champignon",
        "repons2": "un puceron",
        "repons3": "une araignée",
        "repons4": "une bactérie",
        "correct": "un puceron"
    },
    ...
    {
        "repons1": "une carafe de decantation",
        "repons2": "un couteau",
        "repons3": "une sorte de verre à boire",
        "repons4": "un tirebouchon",
        "correct": "un tirebouchon"
    }];


let bonnereponse = 0;/*les variables*/
...
/* on initialise le 1er objet pour initier*/
...
$("#rep").hide();/*on masque la div des resultat/reponse*/

for (let l = 1; l <= 4; l++) {/*boucle pour les autre questions/reponses*/
    $("#a" + l).click(function () {


        console.log("B :" + arrObj[i].reponses);
        console.log("U :" + l);
        if (arrObj[i].reponses == l) {/*condition si gagne si perd*/
            score++;
        ...
        clik++;
        i++;
        if (clik > 9) {/*condition de fin de partie*/
            $("#total").hide()
            $("#rep").show()
            resultat();
            clearTimeout(temps1);
        ...
        $("#questions").fadeOut(1000, function () {/*animation des question reponses jquery*/
...
function resultat() {/*page des resultats*/
